...
describe( 'Returns string with valid CSS class name for valid ratio or opacity number input', () => {
	test.each( [
...
describe( 'Returns string with valid rounded CSS class name for valid ratio or opacity number input', () => {
	test.each( [
...
describe( "Returns empty string for valid input number '0' or '50'", () => {
	test.each( [
		[ 0, '' ],
		[ 50, '' ],
	] )( 'when given %p it returns %p', ( input, expected ) => {
...
describe( 'Returns invalid string for unbounded ratio or opacity number input', () => {
	test.each( [
